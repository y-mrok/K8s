...
## Tips
- YAML のコードを書くには Micorosft Visual Studio を推奨している
  - 拡張機能
...
- Replication Set が主流（ Replication Controller は古い技術）
  ...
  template:
    ...
    selector: 
      matchLabels:
        type: front-end
```
2. kubectl replica コマンドを実行
```
kubectl replica -f replicaset-definistion.yml
```
##### 方法#2
```
